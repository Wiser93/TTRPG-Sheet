      ...
      choices: [
        {
          ...
          count: 1,
          options: [
            { id: 'water', label: 'Water — Stillness (Tier 1)', description: 'Riptide Step, Flowing Form. Recharge: reaction used when attacked.' },
            { id: 'earth', label: 'Earth — Rooted (Tier 1)',   description: 'Earthen Grasp, Stone\'s Endurance. Recharge: no movement on turn.' },
            { id: 'fire',  label: 'Fire — The Flame Within (Tier 1)', description: 'Flame Lash, Kindled Motion. Recharge: reduce enemy to 0 HP with Fire.' },
            { id: 'air',   label: 'Air — Whisper (Tier 1)',    description: 'Cyclone Palm, Whisperstep. Recharge: move 20ft unharmed.' },
          ],
        },
      ],
    },
